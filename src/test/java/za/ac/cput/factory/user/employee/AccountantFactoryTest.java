...
public class AccountantFactoryTest {
    ...
    public void testCreateAccountant() {
        ...
        assertNotNull(accountant.getAccountantID());
    ...
    public void testCreateAccountantWithUniqueIdentifier() {
        ...
        assertNotNull(accountant1.getAccountantID());
        assertNotNull(accountant2.getAccountantID());

        // Verify that the IDs are unique
        assertNotEquals(accountant1.getAccountantID(), accountant2.getAccountantID());
     }
    }
